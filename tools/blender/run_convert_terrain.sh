...
TERRAIN_ENV_DIR="$SCRIPT_DIR/../terrain/terrain_generation/terrain_env"
PYTHON_SCRIPT="$TERRAIN_ENV_DIR/export_glb.py"
BLEND_FILE="$TERRAIN_ENV_DIR/blender_templates/mars_procedural_1.blend"

...
import { loadingManager, textureLoadingManager, loadModelFromRegistry, } from './appConfig/loaders.js';
...
export function createSpacecraft(scene) {
    ...
    const loadCockpitModel = new Promise((resolve, reject) => {
        loadModelFromRegistry(
            ...
            (xhr) => {
                console.log(`Cockpit: ${(xhr.loaded / xhr.total * 100).toFixed(2)}% loaded`);
            },
            (error) => {

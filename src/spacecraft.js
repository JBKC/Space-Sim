...
import { loadingManager, textureLoadingManager, loadModel } from './appConfig/loaders.js';
...
export function createSpacecraft(scene) {
    ...
    function tryLoadWithMultiplePaths(modelFile, onSuccess, onProgress, onError) {

...
function initSpacecraft() {
 ...
 if (spacecraftComponents.reticle) {
   console.log("Reticle was successfully created with spacecraft in sanFranCesium.js");
 } else {
...
export function updateCamera() {
    ...
    // For sanFranCesium we'll use a simpler camera approach without all the cinematic effects

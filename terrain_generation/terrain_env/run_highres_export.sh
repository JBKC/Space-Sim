...
PYTHON_SCRIPT="$SCRIPT_DIR/blender_export_highres.py"
...
echo "Running High-Resolution Python script: $PYTHON_SCRIPT"
echo "On Blender file: $BLEND_FILE"
echo "This process may take several minutes due to high subdivision levels."
...
if [ $? -eq 0 ]; then
    echo "High-Resolution Export completed successfully!"
    echo "New GLB file is available at: $SCRIPT_DIR/blender_templates/mars_terrain_highres.glb"
else
    echo "Failed to export high-resolution GLB file"
fi 